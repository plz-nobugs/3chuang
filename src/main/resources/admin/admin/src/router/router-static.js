...
import chatSessions from '@/views/modules/chat/sessions'
import chatDetail from '@/views/modules/chat/detail'
...
const routes = [{
  ...
  children: [{
    ...
    },
    {
      ...
      meta: {icon:'', title:'chatDetail', activeMenu: '/chat/sessions'}
    },
    {
      path: '/lockerstatus',
      component: () => import('@/views/modules/lockerstatus/list'),
      name: 'lockerstatus',
      meta: { title: '快递柜状态' }
    },
    {
      ...
      name: '数据大屏',
      component: dashboard,
      meta: { title: '数据大屏', icon: 'el-icon-data-analysis' }
    }
  ]
},
  {
